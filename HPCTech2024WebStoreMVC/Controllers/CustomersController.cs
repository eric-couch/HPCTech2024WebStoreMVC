...
namespace HPCTech2024WebStoreMVC.Controllers
{
    ...
    {
        private readonly Hpctech2024SpringOrderSystemContext _context;

        public CustomersController(Hpctech2024SpringOrderSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customers != null ? 
                          ...
                          Problem("Entity set 'Hpctech2024SpringOrderSystemContext.Customers'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Hpctech2024SpringOrderSystemContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
